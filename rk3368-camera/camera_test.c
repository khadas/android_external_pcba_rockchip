...
int extdev_register(void)
{
    ...
    strlcpy((char*)extdev.pwrdn.name, BACK_SENSOR_PWRDN_PIN,sizeof(extdev.pwrdn.name));
    extdev.pwrdn.active = 0x00;
    strlcpy((char*)extdev.pwren.name, BACK_SENSOR_PWREN_PIN,sizeof(extdev.pwren.name));
    extdev.pwren.active = 0x01;
    strlcpy((char*)extdev.rst.name,BACK_SENSOR_RESET_PIN,sizeof(extdev.rst.name));
...
int extdev_register_front(void)
{
    ...
    extdev.afvdd.min_uv = 0x0;
    extdev.afvdd.max_uv = 0x0;
    strlcpy((char*)extdev.pwrdn.name, FRONT_SENSOR_PWRDN_PIN,sizeof(extdev.pwrdn.name));
    extdev.pwrdn.active = 0x01;
    strlcpy((char*)extdev.pwren.name, FRONT_SENSOR_PWREN_PIN,sizeof(extdev.pwren.name));
    extdev.pwren.active = 0x01;
    strlcpy((char*)extdev.rst.name,FRONT_SENSOR_RESET_PIN,sizeof(extdev.rst.name));
	extdev.rst.active = 0x0;
    strlcpy((char*)extdev.afpwrdn.name,"NC",sizeof(extdev.afpwrdn.name));
	extdev.afpwrdn.active = 0x0;
    strlcpy((char*)extdev.afpwr.name,"NC",sizeof(extdev.afpwr.name));
